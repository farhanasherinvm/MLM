# Generated by Django 5.2.4 on 2025-09-11 05:45
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('placement_id', models.CharField(blank=True, max_length=100, null=True)),
                ('pincode', models.CharField(max_length=10)),
                ('payment_type', models.CharField(choices=[('GPay', 'GPay'), ('PhonePe', 'PhonePe'), ('CredPay', 'CredPay')], max_length=20)),
