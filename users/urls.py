...
urlpatterns = [
    ...
    path("payments/", AdminVerifyPaymentView.as_view(), name="admin-list-pending-payments"),
    path("payments/<int:payment_id>/", AdminVerifyPaymentView.as_view(), name="admin-verify-payment"),
