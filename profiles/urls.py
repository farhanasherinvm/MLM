...
from .views import ProfileView,KYCView,ReferralView,ReferralListView,AdminHomeView,ReferralExportView,CurrentUserProfileView,FreePlacementListView,PlacementAvailabilityView
...
urlpatterns = [
    ...
    path("placement/available/", PlacementAvailabilityView.as_view(), name="placement-available"),  #use for auto
